...
implements NetByteBufSerializer<SessionConfig> {
    @Override
    public SessionConfig read(NetByteBuf byteBuf) {
        return new SessionConfig(byteBuf.read(new ConstraintConfigSerializer()), byteBuf.readMap(NetByteBuf::readUUID, new ConstraintConfigSerializer()));
    }
