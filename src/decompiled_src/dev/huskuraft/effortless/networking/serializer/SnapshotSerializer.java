...
import dev.huskuraft.effortless.networking.serializer.BlockDataSerializer;

public class SnapshotSerializer
implements NetByteBufSerializer<Snapshot> {
    @Override
    public Snapshot read(NetByteBuf byteBuf) {
        return new Snapshot(byteBuf.readString(), byteBuf.readLong(), byteBuf.readList(new BlockDataSerializer()));
    }
