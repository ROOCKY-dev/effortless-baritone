...
implements NetByteBufSerializer<BlockData> {
    @Override
    public BlockData read(NetByteBuf byteBuf) {
        return new BlockData(byteBuf.read(new BlockPositionSerializer()), byteBuf.readNullable(NetByteBuf::readBlockState), byteBuf.readNullable(NetByteBuf::readRecordTag));
    }
