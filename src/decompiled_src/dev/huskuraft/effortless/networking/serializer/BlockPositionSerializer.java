...
public class BlockPositionSerializer
implements NetByteBufSerializer<BlockPosition> {
    @Override
    public BlockPosition read(NetByteBuf byteBuf) {
        return BlockPosition.at(byteBuf.readVarInt(), byteBuf.readVarInt(), byteBuf.readVarInt());
    }
