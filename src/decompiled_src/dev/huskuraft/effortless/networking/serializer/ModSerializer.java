...
implements NetByteBufSerializer<Mod> {
    @Override
    public Mod read(NetByteBuf byteBuf) {
        return Mod.create(byteBuf.readNullable(NetByteBuf::readString), byteBuf.readNullable(NetByteBuf::readString), byteBuf.readNullable(NetByteBuf::readString), byteBuf.readNullable(NetByteBuf::readString));
    }
