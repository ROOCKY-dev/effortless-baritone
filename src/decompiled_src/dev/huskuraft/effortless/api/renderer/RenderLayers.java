...
public abstract class RenderLayers {
    ...
    protected static final RenderState.DepthTestState NEVER_DEPTH_TEST = RenderState.DepthTestState.create("never", 512);
    protected static final RenderState.DepthTestState LESS_DEPTH_TEST = RenderState.DepthTestState.create("less", 513);
    protected static final RenderState.DepthTestState EQUAL_DEPTH_TEST = RenderState.DepthTestState.create("equal", 514);
    protected static final RenderState.DepthTestState LEQUAL_DEPTH_TEST = RenderState.DepthTestState.create("lequal", 515);
    protected static final RenderState.DepthTestState GREATER_DEPTH_TEST = RenderState.DepthTestState.create("greater", 516);
    protected static final RenderState.DepthTestState NOTEQUAL_DEPTH_TEST = RenderState.DepthTestState.create("notequal", 517);
    protected static final RenderState.DepthTestState GEQUAL_DEPTH_TEST = RenderState.DepthTestState.create("gequal", 518);
    protected static final RenderState.DepthTestState ALWAYS_DEPTH_TEST = RenderState.DepthTestState.create("always", 519);
    ...
    protected static final RenderState.LineState DEFAULT_WIDTH = RenderState.LineState.create("default_width", 1.0);
