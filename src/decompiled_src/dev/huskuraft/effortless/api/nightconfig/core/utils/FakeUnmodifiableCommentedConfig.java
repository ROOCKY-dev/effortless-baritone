...
implements UnmodifiableCommentedConfig {
    ...
    public Set<? extends UnmodifiableCommentedConfig.Entry> entrySet() {
        return new TransformingSet<UnmodifiableConfig.Entry, FakeCommentedEntry>(this.config.entrySet(), x$0 -> new FakeCommentedEntry((UnmodifiableConfig.Entry)x$0), o -> null, o -> o);
    }
